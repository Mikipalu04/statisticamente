...
TEAMS_DB = {
    ...
    'Torino': {
        'logo': 'https://upload.wikimedia.org/wikipedia/it/2/2e/Torino_FC_logo.png',
        'tiri_fatti': 11.4, 'tiri_concessi': 11.8, 'porta_fatti': 3.7, 'porta_concessi': 3.7
    },
    'Verona': {
    ...
    'Empoli': {
        'logo': 'https://upload.wikimedia.org/wikipedia/it/a/a3/Empoli_FC_logo_2021.svg',
        'tiri_fatti': 11.0, 'tiri_concessi': 15.0, 'porta_fatti': 3.4, 'porta_concessi': 4.9
    },
    'Parma': {
        'logo': 'https://upload.wikimedia.org/wikipedia/commons/9/94/Parma_Calcio_1913_logo.svg',
        'tiri_fatti': 12.0, 'tiri_concessi': 13.8, 'porta_fatti': 3.8, 'porta_concessi': 4.4
    },
    'Udinese': {
        'logo': 'https://upload.wikimedia.org/wikipedia/it/c/c2/Udinese_Calcio_logo.svg',
        'tiri_fatti': 11.2, 'tiri_concessi': 13.1, 'porta_fatti': 3.5, 'porta_concessi': 4.1
    },
    'Cagliari': {
        'logo': 'https://upload.wikimedia.org/wikipedia/it/8/88/Cagliari_calcio.svg',
        'tiri_fatti': 12.2, 'tiri_concessi': 13.9, 'porta_fatti': 3.8, 'porta_concessi': 4.3
    },
    'Como': {
        'logo': 'https://upload.wikimedia.org/wikipedia/it/1/1c/Como_1907_logo.svg',
        'tiri_fatti': 11.8, 'tiri_concessi': 13.5, 'porta_fatti': 3.7, 'porta_concessi': 4.2
    },
    'Monza': {
        'logo': 'https://upload.wikimedia.org/wikipedia/commons/2/2e/AC_Monza_logo_2021.svg',
        'tiri_fatti': 11.1, 'tiri_concessi': 14.0, 'porta_fatti': 3.5, 'porta_concessi': 4.6
    },
    'Genoa': {
        'logo': 'https://upload.wikimedia.org/wikipedia/it/c/ce/Genoa_CFC_logo.svg',
        'tiri_fatti': 10.6, 'tiri_concessi': 12.8, 'porta_fatti': 3.3, 'porta_concessi': 3.9
    }
}
