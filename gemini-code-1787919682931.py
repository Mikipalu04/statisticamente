...
# ---------------------------------------------------------
# DATABASE STORICO SERIE A: LOGHI E METRICHE AVANZATE
# (Tiri, Angoli, Cartellini e Falli)
# ---------------------------------------------------------
TEAMS_DB = {
    'AC Milan': {
    ...
    <div class="match-card">
        <div style="display: flex; justify-content: space-around; align-items: center; text-align: center;">
            <div style="flex: 1;">
                ...
                <span style="color: #9ca3af; font-size: 13px;">Casa</span>
            </div>
            <div>
            ...
            <div style="flex: 1;">
                ...
                <span style="color: #9ca3af; font-size: 13px;">Trasferta</span>
            </div>
        </div>
    </div>
""", unsafe_allow_html=True)
...
with t4:
    st.markdown(f'<div class="metric-container"><div class="metric-value">{falli_totali:.1f} / {cartellini_totali:.1f}</div><div class="metric-label">Falli Attesi / Cartellini</div></div>', unsafe_allow_html=True)
